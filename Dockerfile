FROM --platform=linux/arm64 mcr.microsoft.com/dotnet/sdk:10.0.102-jammy-arm64v8 AS build
WORKDIR /src
...
FROM --platform=linux/arm64 mcr.microsoft.com/dotnet/aspnet:10.0.2-jammy-arm64v8 AS runtime
WORKDIR /app
RUN apt-get update \
